...
const Futures = () => {
  return (
    <div className="w-screen lg:px-[20%] flex gap-[10%] flex-wrap p-[30px] justify-center">
      {/*  */}
      <span className="flex flex-col items-center justify-center w-full max-w-[120px]">
